...
| 11.7 | **Portfolio concentration guardrails** — sector cap (block new entry if ≥ N open positions in same GICS sector) and shared-symbol conflict rejection. | ⬜ |
| 11.8 | **Advanced per-sector capital cap** — hard notional ceiling per GICS sector across all strategies combined. | ⬜ |
