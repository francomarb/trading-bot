...
| 11.25 | **SPY options contract-picker refinements** — the 2026-05-08 hotfix makes contract selection safe by constraining the strike band around the intended slightly-ITM target and paginating through the chain, preventing deep-ITM contracts from being chosen off a truncated first page. Follow-up work should improve *quality*, not just safety: explicitly rank candidate contracts by target-strike / target-delta proximity, spread quality, sleeve affordability, and premium sanity; prefer the best affordable near-target contract rather than the mathematically closest strike alone. Acceptance: selected contracts stay in the intended slightly-ITM neighborhood, avoid oversized premium surprises, and remain explainable in logs. | ⬜ |
