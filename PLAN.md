...
| SPY option trailing durability | 🔄 Quality fix in review | PR #46 merged durable HWM, GTC protection, and atomic Alpaca replacements. June 12/15 paper fills exposed replacement decisions based on non-executable position marks; the follow-up requires a fresh two-sided option quote and bid safety buffer before increasing a stop, while preserving existing protection and all TIF/qty repairs. |
