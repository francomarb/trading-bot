...
| ~~`11.73` Donchian parameter rebaseline on the durable pool~~ | ✅ **COMPLETE — retain 30/15.** A pre-registered shared-sleeve SIP comparison tested 20/10, 30/10, current 30/15, and 55/20 over five annual held-out folds. 55/20 had the best stitched Sharpe (1.03 vs 0.82) but beat 30/15 return in only 3/5 years, failing the fixed 4/5 stability bar. The expanding selector chose 30/15 in four folds. This is a current-cohort robustness study, not a survivorship-free selector test. See [`docs/donchian_parameter_rebaseline.md`](docs/donchian_parameter_rebaseline.md). | Keep 30/15 and collect the new universe's paper cohort. Reopen parameters only with materially new evidence and a new pre-registration; do not salvage 55/20 by changing this test after the result. |
